...
#function that subtracts number of books issued from total number of books available
def bookup(co,u):
...
#function to clear member after returning book
def dsubmit():
 ad=input("enter name:")
